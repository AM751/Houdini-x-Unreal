...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterChoice;
UClass* UHoudiniParameterChoice::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterChoice;
	if (!Z_Registration_Info_UClass_UHoudiniParameterChoice.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterChoice"),
			Z_Registration_Info_UClass_UHoudiniParameterChoice.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterChoice,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterChoice.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterChoice_NoRegister()
{
	return UHoudiniParameterChoice::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterChoice_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterChoice, UHoudiniParameterChoice::StaticClass, TEXT("UHoudiniParameterChoice"), &Z_Registration_Info_UClass_UHoudiniParameterChoice, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterChoice), 3599396268U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterChoice_h__Script_HoudiniEngineRuntime_2323388302(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterChoice_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterChoice_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
