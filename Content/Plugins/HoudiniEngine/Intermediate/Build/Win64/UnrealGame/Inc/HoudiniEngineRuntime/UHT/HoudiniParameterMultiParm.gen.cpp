...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterMultiParm;
UClass* UHoudiniParameterMultiParm::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterMultiParm;
	if (!Z_Registration_Info_UClass_UHoudiniParameterMultiParm.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterMultiParm"),
			Z_Registration_Info_UClass_UHoudiniParameterMultiParm.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterMultiParm,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterMultiParm.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterMultiParm_NoRegister()
{
	return UHoudiniParameterMultiParm::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterMultiParm_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterMultiParm, UHoudiniParameterMultiParm::StaticClass, TEXT("UHoudiniParameterMultiParm"), &Z_Registration_Info_UClass_UHoudiniParameterMultiParm, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterMultiParm), 192899020U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterMultiParm_h__Script_HoudiniEngineRuntime_3170672251(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterMultiParm_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterMultiParm_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterMultiParm_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterMultiParm_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
