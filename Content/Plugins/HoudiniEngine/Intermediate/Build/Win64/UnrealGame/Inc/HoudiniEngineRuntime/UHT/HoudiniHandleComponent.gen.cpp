...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniHandleParameter;
UClass* UHoudiniHandleParameter::GetPrivateStaticClass()
{
	using TClass = UHoudiniHandleParameter;
	if (!Z_Registration_Info_UClass_UHoudiniHandleParameter.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniHandleParameter"),
			Z_Registration_Info_UClass_UHoudiniHandleParameter.InnerSingleton,
			StaticRegisterNativesUHoudiniHandleParameter,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniHandleParameter.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniHandleParameter_NoRegister()
{
	return UHoudiniHandleParameter::GetPrivateStaticClass();
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniHandleComponent;
UClass* UHoudiniHandleComponent::GetPrivateStaticClass()
{
	using TClass = UHoudiniHandleComponent;
	if (!Z_Registration_Info_UClass_UHoudiniHandleComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniHandleComponent"),
			Z_Registration_Info_UClass_UHoudiniHandleComponent.InnerSingleton,
			StaticRegisterNativesUHoudiniHandleComponent,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniHandleComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniHandleComponent_NoRegister()
{
	return UHoudiniHandleComponent::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniHandleComponent_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniHandleParameter, UHoudiniHandleParameter::StaticClass, TEXT("UHoudiniHandleParameter"), &Z_Registration_Info_UClass_UHoudiniHandleParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniHandleParameter), 2310682439U) },
		{ Z_Construct_UClass_UHoudiniHandleComponent, UHoudiniHandleComponent::StaticClass, TEXT("UHoudiniHandleComponent"), &Z_Registration_Info_UClass_UHoudiniHandleComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniHandleComponent), 1524715582U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniHandleComponent_h__Script_HoudiniEngineRuntime_1028331466(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniHandleComponent_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniHandleComponent_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniHandleComponent_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniHandleComponent_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
