...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterButtonStrip;
UClass* UHoudiniParameterButtonStrip::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterButtonStrip;
	if (!Z_Registration_Info_UClass_UHoudiniParameterButtonStrip.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterButtonStrip"),
			Z_Registration_Info_UClass_UHoudiniParameterButtonStrip.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterButtonStrip,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterButtonStrip.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterButtonStrip_NoRegister()
{
	return UHoudiniParameterButtonStrip::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterButtonStrip_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterButtonStrip, UHoudiniParameterButtonStrip::StaticClass, TEXT("UHoudiniParameterButtonStrip"), &Z_Registration_Info_UClass_UHoudiniParameterButtonStrip, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterButtonStrip), 226791282U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterButtonStrip_h__Script_HoudiniEngineRuntime_4070920302(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterButtonStrip_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterButtonStrip_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
