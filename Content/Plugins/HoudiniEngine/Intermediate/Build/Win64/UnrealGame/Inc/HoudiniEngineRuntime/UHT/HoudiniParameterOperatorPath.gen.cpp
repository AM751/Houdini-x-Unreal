...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterOperatorPath;
UClass* UHoudiniParameterOperatorPath::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterOperatorPath;
	if (!Z_Registration_Info_UClass_UHoudiniParameterOperatorPath.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterOperatorPath"),
			Z_Registration_Info_UClass_UHoudiniParameterOperatorPath.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterOperatorPath,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterOperatorPath.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterOperatorPath_NoRegister()
{
	return UHoudiniParameterOperatorPath::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterOperatorPath_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterOperatorPath, UHoudiniParameterOperatorPath::StaticClass, TEXT("UHoudiniParameterOperatorPath"), &Z_Registration_Info_UClass_UHoudiniParameterOperatorPath, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterOperatorPath), 3357849295U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterOperatorPath_h__Script_HoudiniEngineRuntime_3383981412(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterOperatorPath_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterOperatorPath_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
