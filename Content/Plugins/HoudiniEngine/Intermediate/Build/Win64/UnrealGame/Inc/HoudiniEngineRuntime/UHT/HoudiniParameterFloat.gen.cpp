...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterFloat;
UClass* UHoudiniParameterFloat::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterFloat;
	if (!Z_Registration_Info_UClass_UHoudiniParameterFloat.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterFloat"),
			Z_Registration_Info_UClass_UHoudiniParameterFloat.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterFloat,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterFloat.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterFloat_NoRegister()
{
	return UHoudiniParameterFloat::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFloat_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterFloat, UHoudiniParameterFloat::StaticClass, TEXT("UHoudiniParameterFloat"), &Z_Registration_Info_UClass_UHoudiniParameterFloat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterFloat), 706685913U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFloat_h__Script_HoudiniEngineRuntime_148854923(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFloat_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFloat_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
