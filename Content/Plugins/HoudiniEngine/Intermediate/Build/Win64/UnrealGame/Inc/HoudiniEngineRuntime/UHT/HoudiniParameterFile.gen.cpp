...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterFile;
UClass* UHoudiniParameterFile::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterFile;
	if (!Z_Registration_Info_UClass_UHoudiniParameterFile.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterFile"),
			Z_Registration_Info_UClass_UHoudiniParameterFile.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterFile,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterFile.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterFile_NoRegister()
{
	return UHoudiniParameterFile::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFile_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterFile, UHoudiniParameterFile::StaticClass, TEXT("UHoudiniParameterFile"), &Z_Registration_Info_UClass_UHoudiniParameterFile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterFile), 3001348886U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFile_h__Script_HoudiniEngineRuntime_1433254096(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFile_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFile_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
