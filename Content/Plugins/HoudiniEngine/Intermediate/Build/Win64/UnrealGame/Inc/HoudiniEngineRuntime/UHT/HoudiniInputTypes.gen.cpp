...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniInputObjectSettings;
class UScriptStruct* FHoudiniInputObjectSettings::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniInputObjectSettings.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniInputObjectSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniInputObjectSettings, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("HoudiniInputObjectSettings"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniInputObjectSettings.OuterSingleton;
}
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Indicates that we want to export the main mesh for a given object\n// Turning this off will allow to only send colliders for example\n" },
#endif
		{ "ModuleRelativePath", "Private/HoudiniInputTypes.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Indicates that we want to export the main mesh for a given object\nTurning this off will allow to only send colliders for example" },
#endif
	};
...
void Z_Construct_UScriptStruct_FHoudiniInputObjectSettings_Statics::NewProp_bExportMainGeometry_SetBit(void* Obj)
{
	((FHoudiniInputObjectSettings*)Obj)->bExportMainGeometry = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FHoudiniInputObjectSettings_Statics::NewProp_bExportMainGeometry = { "bExportMainGeometry", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FHoudiniInputObjectSettings), &Z_Construct_UScriptStruct_FHoudiniInputObjectSettings_Statics::NewProp_bExportMainGeometry_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bExportMainGeometry_MetaData), NewProp_bExportMainGeometry_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FHoudiniInputObjectSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FHoudiniInputObjectSettings_Statics::NewProp_bExportMainGeometry,
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniInputObjectSettings.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniInputObjectSettings.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniInputObjectSettings_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniInputObjectSettings.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniInputObjectSettings *****************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputTypes_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniInputObjectSettings::StaticStruct, Z_Construct_UScriptStruct_FHoudiniInputObjectSettings_Statics::NewStructOps, TEXT("HoudiniInputObjectSettings"), &Z_Registration_Info_UScriptStruct_FHoudiniInputObjectSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniInputObjectSettings), 1069504080U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputTypes_h__Script_HoudiniEngineRuntime_2870385322(TEXT("/Script/HoudiniEngineRuntime"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputTypes_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputTypes_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputTypes_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniInputTypes_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
