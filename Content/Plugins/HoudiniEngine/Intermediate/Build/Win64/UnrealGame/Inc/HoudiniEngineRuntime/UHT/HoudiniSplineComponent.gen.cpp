...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniSplineComponent;
UClass* UHoudiniSplineComponent::GetPrivateStaticClass()
{
	using TClass = UHoudiniSplineComponent;
	if (!Z_Registration_Info_UClass_UHoudiniSplineComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniSplineComponent"),
			Z_Registration_Info_UClass_UHoudiniSplineComponent.InnerSingleton,
			StaticRegisterNativesUHoudiniSplineComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniSplineComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniSplineComponent_NoRegister()
{
	return UHoudiniSplineComponent::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UHoudiniSplineComponent_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UHoudiniEngineCopyPropertiesInterface_NoRegister, (int32)VTABLE_OFFSET(UHoudiniSplineComponent, IHoudiniEngineCopyPropertiesInterface), false },  // 2601619219
};
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniSplineComponentInstanceData;
class UScriptStruct* FHoudiniSplineComponentInstanceData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniSplineComponentInstanceData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniSplineComponentInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniSplineComponentInstanceData, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("HoudiniSplineComponentInstanceData"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniSplineComponentInstanceData.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniSplineComponentInstanceData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniSplineComponentInstanceData.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniSplineComponentInstanceData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniSplineComponentInstanceData.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniSplineComponentInstanceData *********************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniSplineComponent_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniSplineComponentInstanceData::StaticStruct, Z_Construct_UScriptStruct_FHoudiniSplineComponentInstanceData_Statics::NewStructOps, TEXT("HoudiniSplineComponentInstanceData"), &Z_Registration_Info_UScriptStruct_FHoudiniSplineComponentInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniSplineComponentInstanceData), 2264242052U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniSplineComponent, UHoudiniSplineComponent::StaticClass, TEXT("UHoudiniSplineComponent"), &Z_Registration_Info_UClass_UHoudiniSplineComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniSplineComponent), 35816094U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniSplineComponent_h__Script_HoudiniEngineRuntime_2481103421(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniSplineComponent_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniSplineComponent_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniSplineComponent_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniSplineComponent_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
