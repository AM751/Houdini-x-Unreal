...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier;
class UScriptStruct* FHoudiniPublicAPIOutputObjectIdentifier::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPublicAPIOutputObjectIdentifier"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniPublicAPIOutputObjectIdentifier *****************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIOutputTypes_h__Script_HoudiniEngineEditor_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniPublicAPIOutputObjectIdentifier::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier_Statics::NewStructOps, TEXT("HoudiniPublicAPIOutputObjectIdentifier"), &Z_Registration_Info_UScriptStruct_FHoudiniPublicAPIOutputObjectIdentifier, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPublicAPIOutputObjectIdentifier), 1544720452U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIOutputTypes_h__Script_HoudiniEngineEditor_675964240(TEXT("/Script/HoudiniEngineEditor"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIOutputTypes_h__Script_HoudiniEngineEditor_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIOutputTypes_h__Script_HoudiniEngineEditor_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
