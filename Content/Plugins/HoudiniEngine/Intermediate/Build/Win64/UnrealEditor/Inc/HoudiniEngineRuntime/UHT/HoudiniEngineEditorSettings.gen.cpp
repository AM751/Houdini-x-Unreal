...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FUserPackageRules;
class UScriptStruct* FUserPackageRules::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FUserPackageRules.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FUserPackageRules.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUserPackageRules, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("UserPackageRules"));
	}
	return Z_Registration_Info_UScriptStruct_FUserPackageRules.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FUserPackageRules.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FUserPackageRules.InnerSingleton, Z_Construct_UScriptStruct_FUserPackageRules_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FUserPackageRules.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FUserCategoryRules;
class UScriptStruct* FUserCategoryRules::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FUserCategoryRules.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FUserCategoryRules.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUserCategoryRules, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("UserCategoryRules"));
	}
	return Z_Registration_Info_UScriptStruct_FUserCategoryRules.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FUserCategoryRules.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FUserCategoryRules.InnerSingleton, Z_Construct_UScriptStruct_FUserCategoryRules_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FUserCategoryRules.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniEngineEditorSettings;
UClass* UHoudiniEngineEditorSettings::GetPrivateStaticClass()
{
	using TClass = UHoudiniEngineEditorSettings;
	if (!Z_Registration_Info_UClass_UHoudiniEngineEditorSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniEngineEditorSettings"),
			Z_Registration_Info_UClass_UHoudiniEngineEditorSettings.InnerSingleton,
			StaticRegisterNativesUHoudiniEngineEditorSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniEngineEditorSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniEngineEditorSettings_NoRegister()
{
	return UHoudiniEngineEditorSettings::GetPrivateStaticClass();
}
...
#if WITH_EDITORONLY_DATA
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniEngineEditorSettings_Statics::NewProp_UserToolCategories_ValueProp = { "UserToolCategories", nullptr, (EPropertyFlags)0x0000000800004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FUserCategoryRules, METADATA_PARAMS(0, nullptr) }; // 1353468502
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniEngineEditorSettings_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FUserPackageRules::StaticStruct, Z_Construct_UScriptStruct_FUserPackageRules_Statics::NewStructOps, TEXT("UserPackageRules"), &Z_Registration_Info_UScriptStruct_FUserPackageRules, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUserPackageRules), 258929195U) },
		{ FUserCategoryRules::StaticStruct, Z_Construct_UScriptStruct_FUserCategoryRules_Statics::NewStructOps, TEXT("UserCategoryRules"), &Z_Registration_Info_UScriptStruct_FUserCategoryRules, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUserCategoryRules), 1353468502U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniEngineEditorSettings, UHoudiniEngineEditorSettings::StaticClass, TEXT("UHoudiniEngineEditorSettings"), &Z_Registration_Info_UClass_UHoudiniEngineEditorSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniEngineEditorSettings), 3614996444U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniEngineEditorSettings_h__Script_HoudiniEngineRuntime_1067050517(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniEngineEditorSettings_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniEngineEditorSettings_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniEngineEditorSettings_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniEngineEditorSettings_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniEngineEditorSettings_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniEngineEditorSettings_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
