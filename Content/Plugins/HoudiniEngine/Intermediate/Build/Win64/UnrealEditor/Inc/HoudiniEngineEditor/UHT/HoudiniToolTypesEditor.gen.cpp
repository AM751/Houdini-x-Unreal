...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniToolEditorProperties;
UClass* UHoudiniToolEditorProperties::GetPrivateStaticClass()
{
	using TClass = UHoudiniToolEditorProperties;
	if (!Z_Registration_Info_UClass_UHoudiniToolEditorProperties.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniToolEditorProperties"),
			Z_Registration_Info_UClass_UHoudiniToolEditorProperties.InnerSingleton,
			StaticRegisterNativesUHoudiniToolEditorProperties,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniToolEditorProperties.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniToolEditorProperties_NoRegister()
{
	return UHoudiniToolEditorProperties::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniToolTypesEditor_h__Script_HoudiniEngineEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniToolEditorProperties, UHoudiniToolEditorProperties::StaticClass, TEXT("UHoudiniToolEditorProperties"), &Z_Registration_Info_UClass_UHoudiniToolEditorProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniToolEditorProperties), 1925602047U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniToolTypesEditor_h__Script_HoudiniEngineEditor_3917245645(TEXT("/Script/HoudiniEngineEditor"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniToolTypesEditor_h__Script_HoudiniEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniToolTypesEditor_h__Script_HoudiniEngineEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
