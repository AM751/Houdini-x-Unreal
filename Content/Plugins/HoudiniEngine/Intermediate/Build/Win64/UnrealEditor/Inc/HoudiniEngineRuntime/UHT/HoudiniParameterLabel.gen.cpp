...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterLabel;
UClass* UHoudiniParameterLabel::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterLabel;
	if (!Z_Registration_Info_UClass_UHoudiniParameterLabel.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterLabel"),
			Z_Registration_Info_UClass_UHoudiniParameterLabel.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterLabel,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterLabel.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterLabel_NoRegister()
{
	return UHoudiniParameterLabel::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterLabel_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterLabel, UHoudiniParameterLabel::StaticClass, TEXT("UHoudiniParameterLabel"), &Z_Registration_Info_UClass_UHoudiniParameterLabel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterLabel), 190530525U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterLabel_h__Script_HoudiniEngineRuntime_2873263696(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterLabel_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterLabel_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
