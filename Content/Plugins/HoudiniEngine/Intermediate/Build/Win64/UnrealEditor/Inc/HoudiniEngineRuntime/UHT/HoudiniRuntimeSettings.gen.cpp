...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniStaticMeshGenerationProperties;
class UScriptStruct* FHoudiniStaticMeshGenerationProperties::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniStaticMeshGenerationProperties.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniStaticMeshGenerationProperties.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniStaticMeshGenerationProperties, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineRuntime(), TEXT("HoudiniStaticMeshGenerationProperties"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniStaticMeshGenerationProperties.OuterSingleton;
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniStaticMeshGenerationProperties_Statics::NewProp_DefaultBodyInstance = { "DefaultBodyInstance", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHoudiniStaticMeshGenerationProperties, DefaultBodyInstance), Z_Construct_UScriptStruct_FBodyInstance, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DefaultBodyInstance_MetaData), NewProp_DefaultBodyInstance_MetaData) }; // 289277017
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniStaticMeshGenerationProperties.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniStaticMeshGenerationProperties.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniStaticMeshGenerationProperties_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniStaticMeshGenerationProperties.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniRuntimeSettings;
UClass* UHoudiniRuntimeSettings::GetPrivateStaticClass()
{
	using TClass = UHoudiniRuntimeSettings;
	if (!Z_Registration_Info_UClass_UHoudiniRuntimeSettings.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniRuntimeSettings"),
			Z_Registration_Info_UClass_UHoudiniRuntimeSettings.InnerSingleton,
			StaticRegisterNativesUHoudiniRuntimeSettings,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniRuntimeSettings.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniRuntimeSettings_NoRegister()
{
	return UHoudiniRuntimeSettings::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniRuntimeSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bEnableSharedMemoryDataTransfer_MetaData[] = {
		{ "Category", "Session" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Indicates if shared memory data transfer should be used in the current session.\n// Shared memory data transfer will make data transfer between Unreal and Houdini a lot faster, especially for large amount of data.\n// This can be used with any type of sessions as long as the Houdini Engine session is running on the same machine as the plugin (default: disabled)\n" },
#endif
		{ "ModuleRelativePath", "Private/HoudiniRuntimeSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Indicates if shared memory data transfer should be used in the current session.\nShared memory data transfer will make data transfer between Unreal and Houdini a lot faster, especially for large amount of data.\nThis can be used with any type of sessions as long as the Houdini Engine session is running on the same machine as the plugin (default: disabled)" },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bUseSessionSyncForAutomaticServer_MetaData[] = {
		{ "Category", "Session" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Automatically created servers create a Session Sync session. (default: disabled)\n" },
#endif
		{ "ModuleRelativePath", "Private/HoudiniRuntimeSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Automatically created servers create a Session Sync session. (default: disabled)" },
#endif
	};
	...
	static void NewProp_bEnableSharedMemoryDataTransfer_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bEnableSharedMemoryDataTransfer;
	...
	static void NewProp_bUseSessionSyncForAutomaticServer_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bUseSessionSyncForAutomaticServer;
...
void Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::NewProp_bEnableSharedMemoryDataTransfer_SetBit(void* Obj)
{
	((UHoudiniRuntimeSettings*)Obj)->bEnableSharedMemoryDataTransfer = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::NewProp_bEnableSharedMemoryDataTransfer = { "bEnableSharedMemoryDataTransfer", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHoudiniRuntimeSettings), &Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::NewProp_bEnableSharedMemoryDataTransfer_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bEnableSharedMemoryDataTransfer_MetaData), NewProp_bEnableSharedMemoryDataTransfer_MetaData) };
...
void Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::NewProp_bUseSessionSyncForAutomaticServer_SetBit(void* Obj)
{
	((UHoudiniRuntimeSettings*)Obj)->bUseSessionSyncForAutomaticServer = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::NewProp_bUseSessionSyncForAutomaticServer = { "bUseSessionSyncForAutomaticServer", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHoudiniRuntimeSettings), &Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::NewProp_bUseSessionSyncForAutomaticServer_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bUseSessionSyncForAutomaticServer_MetaData), NewProp_bUseSessionSyncForAutomaticServer_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::NewProp_bEnableSharedMemoryDataTransfer,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniRuntimeSettings_Statics::NewProp_bUseSessionSyncForAutomaticServer,
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniRuntimeSettings_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniStaticMeshGenerationProperties::StaticStruct, Z_Construct_UScriptStruct_FHoudiniStaticMeshGenerationProperties_Statics::NewStructOps, TEXT("HoudiniStaticMeshGenerationProperties"), &Z_Registration_Info_UScriptStruct_FHoudiniStaticMeshGenerationProperties, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniStaticMeshGenerationProperties), 2614411381U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniRuntimeSettings, UHoudiniRuntimeSettings::StaticClass, TEXT("UHoudiniRuntimeSettings"), &Z_Registration_Info_UClass_UHoudiniRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniRuntimeSettings), 728493282U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniRuntimeSettings_h__Script_HoudiniEngineRuntime_4071795752(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniRuntimeSettings_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniRuntimeSettings_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniRuntimeSettings_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniRuntimeSettings_h__Script_HoudiniEngineRuntime_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniRuntimeSettings_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniRuntimeSettings_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
