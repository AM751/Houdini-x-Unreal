...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniToolDirectory;
class UScriptStruct* FHoudiniToolDirectory::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniToolDirectory.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniToolDirectory.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniToolDirectory, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniToolDirectory"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniToolDirectory.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniToolDirectory.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniToolDirectory.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniToolDirectory_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniToolDirectory.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniToolCategory;
class UScriptStruct* FHoudiniToolCategory::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniToolCategory.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniToolCategory.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniToolCategory, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniToolCategory"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniToolCategory.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniToolCategory.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniToolCategory.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniToolCategory_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniToolCategory.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniToolCategory ************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEngineToolTypes_h__Script_HoudiniEngineEditor_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniToolDirectory::StaticStruct, Z_Construct_UScriptStruct_FHoudiniToolDirectory_Statics::NewStructOps, TEXT("HoudiniToolDirectory"), &Z_Registration_Info_UScriptStruct_FHoudiniToolDirectory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniToolDirectory), 211465968U) },
		{ FHoudiniToolCategory::StaticStruct, Z_Construct_UScriptStruct_FHoudiniToolCategory_Statics::NewStructOps, TEXT("HoudiniToolCategory"), &Z_Registration_Info_UScriptStruct_FHoudiniToolCategory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniToolCategory), 2075009636U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEngineToolTypes_h__Script_HoudiniEngineEditor_3073416685(TEXT("/Script/HoudiniEngineEditor"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEngineToolTypes_h__Script_HoudiniEngineEditor_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEngineToolTypes_h__Script_HoudiniEngineEditor_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEngineToolTypes_h__Script_HoudiniEngineEditor_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEngineToolTypes_h__Script_HoudiniEngineEditor_Statics::EnumInfo));
// ********** End Registration *********************************************************************
