...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterRampModificationEvent;
UClass* UHoudiniParameterRampModificationEvent::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterRampModificationEvent;
	if (!Z_Registration_Info_UClass_UHoudiniParameterRampModificationEvent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterRampModificationEvent"),
			Z_Registration_Info_UClass_UHoudiniParameterRampModificationEvent.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterRampModificationEvent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterRampModificationEvent.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterRampModificationEvent_NoRegister()
{
	return UHoudiniParameterRampModificationEvent::GetPrivateStaticClass();
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterRampFloatPoint;
UClass* UHoudiniParameterRampFloatPoint::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterRampFloatPoint;
	if (!Z_Registration_Info_UClass_UHoudiniParameterRampFloatPoint.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterRampFloatPoint"),
			Z_Registration_Info_UClass_UHoudiniParameterRampFloatPoint.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterRampFloatPoint,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterRampFloatPoint.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterRampFloatPoint_NoRegister()
{
	return UHoudiniParameterRampFloatPoint::GetPrivateStaticClass();
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterRampColorPoint;
UClass* UHoudiniParameterRampColorPoint::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterRampColorPoint;
	if (!Z_Registration_Info_UClass_UHoudiniParameterRampColorPoint.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterRampColorPoint"),
			Z_Registration_Info_UClass_UHoudiniParameterRampColorPoint.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterRampColorPoint,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterRampColorPoint.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterRampColorPoint_NoRegister()
{
	return UHoudiniParameterRampColorPoint::GetPrivateStaticClass();
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterRampFloat;
UClass* UHoudiniParameterRampFloat::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterRampFloat;
	if (!Z_Registration_Info_UClass_UHoudiniParameterRampFloat.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterRampFloat"),
			Z_Registration_Info_UClass_UHoudiniParameterRampFloat.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterRampFloat,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterRampFloat.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterRampFloat_NoRegister()
{
	return UHoudiniParameterRampFloat::GetPrivateStaticClass();
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterRampColor;
UClass* UHoudiniParameterRampColor::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterRampColor;
	if (!Z_Registration_Info_UClass_UHoudiniParameterRampColor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterRampColor"),
			Z_Registration_Info_UClass_UHoudiniParameterRampColor.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterRampColor,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterRampColor.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterRampColor_NoRegister()
{
	return UHoudiniParameterRampColor::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterRamp_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterRampModificationEvent, UHoudiniParameterRampModificationEvent::StaticClass, TEXT("UHoudiniParameterRampModificationEvent"), &Z_Registration_Info_UClass_UHoudiniParameterRampModificationEvent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterRampModificationEvent), 1779632564U) },
		{ Z_Construct_UClass_UHoudiniParameterRampFloatPoint, UHoudiniParameterRampFloatPoint::StaticClass, TEXT("UHoudiniParameterRampFloatPoint"), &Z_Registration_Info_UClass_UHoudiniParameterRampFloatPoint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterRampFloatPoint), 2066037067U) },
		{ Z_Construct_UClass_UHoudiniParameterRampColorPoint, UHoudiniParameterRampColorPoint::StaticClass, TEXT("UHoudiniParameterRampColorPoint"), &Z_Registration_Info_UClass_UHoudiniParameterRampColorPoint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterRampColorPoint), 3470334520U) },
		{ Z_Construct_UClass_UHoudiniParameterRampFloat, UHoudiniParameterRampFloat::StaticClass, TEXT("UHoudiniParameterRampFloat"), &Z_Registration_Info_UClass_UHoudiniParameterRampFloat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterRampFloat), 1509028072U) },
		{ Z_Construct_UClass_UHoudiniParameterRampColor, UHoudiniParameterRampColor::StaticClass, TEXT("UHoudiniParameterRampColor"), &Z_Registration_Info_UClass_UHoudiniParameterRampColor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterRampColor), 1997483783U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterRamp_h__Script_HoudiniEngineRuntime_3455777534(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterRamp_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterRamp_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterRamp_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterRamp_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
