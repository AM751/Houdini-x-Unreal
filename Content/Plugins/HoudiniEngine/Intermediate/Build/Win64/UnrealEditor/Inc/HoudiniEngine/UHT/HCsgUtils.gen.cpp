...
FClassRegistrationInfo Z_Registration_Info_UClass_UHCsgUtils;
UClass* UHCsgUtils::GetPrivateStaticClass()
{
	using TClass = UHCsgUtils;
	if (!Z_Registration_Info_UClass_UHCsgUtils.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HCsgUtils"),
			Z_Registration_Info_UClass_UHCsgUtils.InnerSingleton,
			StaticRegisterNativesUHCsgUtils,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHCsgUtils.InnerSingleton;
}
UClass* Z_Construct_UClass_UHCsgUtils_NoRegister()
{
	return UHCsgUtils::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h__Script_HoudiniEngine_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHCsgUtils, UHCsgUtils::StaticClass, TEXT("UHCsgUtils"), &Z_Registration_Info_UClass_UHCsgUtils, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHCsgUtils), 369158199U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h__Script_HoudiniEngine_280862626(TEXT("/Script/HoudiniEngine"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h__Script_HoudiniEngine_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HCsgUtils_h__Script_HoudiniEngine_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
