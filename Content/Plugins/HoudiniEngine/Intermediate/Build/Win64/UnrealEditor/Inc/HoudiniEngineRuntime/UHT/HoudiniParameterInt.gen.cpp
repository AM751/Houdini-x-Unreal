...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterInt;
UClass* UHoudiniParameterInt::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterInt;
	if (!Z_Registration_Info_UClass_UHoudiniParameterInt.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterInt"),
			Z_Registration_Info_UClass_UHoudiniParameterInt.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterInt,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterInt.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterInt_NoRegister()
{
	return UHoudiniParameterInt::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterInt_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterInt, UHoudiniParameterInt::StaticClass, TEXT("UHoudiniParameterInt"), &Z_Registration_Info_UClass_UHoudiniParameterInt, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterInt), 3440031443U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterInt_h__Script_HoudiniEngineRuntime_3565746516(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterInt_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterInt_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
