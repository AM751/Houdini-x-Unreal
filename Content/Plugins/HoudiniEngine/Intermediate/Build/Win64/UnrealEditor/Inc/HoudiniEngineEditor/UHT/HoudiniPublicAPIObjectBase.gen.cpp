...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIObjectBase_ClearErrorMessages);
	...
	{
		ClearErrorMessages_Implementation();
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIObjectBase_GetLastErrorMessage);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		HoudiniPublicAPIObjectBase_eventGetLastErrorMessage_Parms Parms;
		Parms.OutLastErrorMessage=OutLastErrorMessage;
		const_cast<UHoudiniPublicAPIObjectBase*>(this)->ProcessEvent(Func,&Parms);
		OutLastErrorMessage=Parms.OutLastErrorMessage;
		return !!Parms.ReturnValue;
	}
	else
	{
		return const_cast<UHoudiniPublicAPIObjectBase*>(this)->GetLastErrorMessage_Implementation(OutLastErrorMessage);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIObjectBase_IsLoggingErrors);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UHoudiniPublicAPIObjectBase*>(this)->IsLoggingErrors_Implementation();
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIObjectBase_SetErrorMessage);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		const_cast<UHoudiniPublicAPIObjectBase*>(this)->SetErrorMessage_Implementation(InErrorMessage, InLoggingOption);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIObjectBase_SetLoggingErrorsEnabled);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SetLoggingErrorsEnabled_Implementation(bInEnabled);
	}
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPublicAPIObjectBase;
UClass* UHoudiniPublicAPIObjectBase::GetPrivateStaticClass()
{
	using TClass = UHoudiniPublicAPIObjectBase;
	if (!Z_Registration_Info_UClass_UHoudiniPublicAPIObjectBase.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPublicAPIObjectBase"),
			Z_Registration_Info_UClass_UHoudiniPublicAPIObjectBase.InnerSingleton,
			StaticRegisterNativesUHoudiniPublicAPIObjectBase,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniPublicAPIObjectBase.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPublicAPIObjectBase_NoRegister()
{
	return UHoudiniPublicAPIObjectBase::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniPublicAPIObjectBase_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_ClearErrorMessages, "ClearErrorMessages" }, // 4001371811
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_GetLastErrorMessage, "GetLastErrorMessage" }, // 445011813
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_IsLoggingErrors, "IsLoggingErrors" }, // 2615582061
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetErrorMessage, "SetErrorMessage" }, // 2002753220
		{ &Z_Construct_UFunction_UHoudiniPublicAPIObjectBase_SetLoggingErrorsEnabled, "SetLoggingErrorsEnabled" }, // 2396193614
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h__Script_HoudiniEngineEditor_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPublicAPIObjectBase, UHoudiniPublicAPIObjectBase::StaticClass, TEXT("UHoudiniPublicAPIObjectBase"), &Z_Registration_Info_UClass_UHoudiniPublicAPIObjectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPIObjectBase), 2982334084U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h__Script_HoudiniEngineEditor_1460067574(TEXT("/Script/HoudiniEngineEditor"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h__Script_HoudiniEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h__Script_HoudiniEngineEditor_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h__Script_HoudiniEngineEditor_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIObjectBase_h__Script_HoudiniEngineEditor_Statics::EnumInfo));
// ********** End Registration *********************************************************************
