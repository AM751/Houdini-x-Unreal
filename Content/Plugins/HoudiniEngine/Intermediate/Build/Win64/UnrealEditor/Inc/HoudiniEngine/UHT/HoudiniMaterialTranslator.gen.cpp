...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniMaterialParameterValue;
class UScriptStruct* FHoudiniMaterialParameterValue::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniMaterialParameterValue.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniMaterialParameterValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniMaterialParameterValue, (UObject*)Z_Construct_UPackage__Script_HoudiniEngine(), TEXT("HoudiniMaterialParameterValue"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniMaterialParameterValue.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniMaterialParameterValue.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniMaterialParameterValue.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniMaterialParameterValue_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniMaterialParameterValue.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniMaterialParameterValue **************************************

// ********** Begin ScriptStruct FHoudiniMaterialInfo **********************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniMaterialInfo;
class UScriptStruct* FHoudiniMaterialInfo::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniMaterialInfo.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniMaterialInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniMaterialInfo, (UObject*)Z_Construct_UPackage__Script_HoudiniEngine(), TEXT("HoudiniMaterialInfo"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniMaterialInfo.OuterSingleton;
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniMaterialInfo_Statics::NewProp_MaterialInstanceParameters_ValueProp = { "MaterialInstanceParameters", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FHoudiniMaterialParameterValue, METADATA_PARAMS(0, nullptr) }; // 3982599714
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniMaterialInfo.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniMaterialInfo.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniMaterialInfo_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniMaterialInfo.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniMaterialInfo ************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniMaterialTranslator_h__Script_HoudiniEngine_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniMaterialParameterValue::StaticStruct, Z_Construct_UScriptStruct_FHoudiniMaterialParameterValue_Statics::NewStructOps, TEXT("HoudiniMaterialParameterValue"), &Z_Registration_Info_UScriptStruct_FHoudiniMaterialParameterValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniMaterialParameterValue), 3982599714U) },
		{ FHoudiniMaterialInfo::StaticStruct, Z_Construct_UScriptStruct_FHoudiniMaterialInfo_Statics::NewStructOps, TEXT("HoudiniMaterialInfo"), &Z_Registration_Info_UScriptStruct_FHoudiniMaterialInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniMaterialInfo), 2913755300U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniMaterialTranslator_h__Script_HoudiniEngine_3093973123(TEXT("/Script/HoudiniEngine"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniMaterialTranslator_h__Script_HoudiniEngine_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniMaterialTranslator_h__Script_HoudiniEngine_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniMaterialTranslator_h__Script_HoudiniEngine_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniMaterialTranslator_h__Script_HoudiniEngine_Statics::EnumInfo));
// ********** End Registration *********************************************************************
