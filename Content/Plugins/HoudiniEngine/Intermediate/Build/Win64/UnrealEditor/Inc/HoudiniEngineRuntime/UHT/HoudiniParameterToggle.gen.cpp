...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterToggle;
UClass* UHoudiniParameterToggle::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterToggle;
	if (!Z_Registration_Info_UClass_UHoudiniParameterToggle.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterToggle"),
			Z_Registration_Info_UClass_UHoudiniParameterToggle.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterToggle,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterToggle.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterToggle_NoRegister()
{
	return UHoudiniParameterToggle::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterToggle_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterToggle, UHoudiniParameterToggle::StaticClass, TEXT("UHoudiniParameterToggle"), &Z_Registration_Info_UClass_UHoudiniParameterToggle, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterToggle), 109009439U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterToggle_h__Script_HoudiniEngineRuntime_2359249110(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterToggle_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterToggle_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
