...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPublicAPIBlueprintLib;
UClass* UHoudiniPublicAPIBlueprintLib::GetPrivateStaticClass()
{
	using TClass = UHoudiniPublicAPIBlueprintLib;
	if (!Z_Registration_Info_UClass_UHoudiniPublicAPIBlueprintLib.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPublicAPIBlueprintLib"),
			Z_Registration_Info_UClass_UHoudiniPublicAPIBlueprintLib.InnerSingleton,
			StaticRegisterNativesUHoudiniPublicAPIBlueprintLib,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniPublicAPIBlueprintLib.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPublicAPIBlueprintLib_NoRegister()
{
	return UHoudiniPublicAPIBlueprintLib::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniPublicAPIBlueprintLib_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniPublicAPIBlueprintLib_GetAPI, "GetAPI" }, // 3081368337
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h__Script_HoudiniEngineEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPublicAPIBlueprintLib, UHoudiniPublicAPIBlueprintLib::StaticClass, TEXT("UHoudiniPublicAPIBlueprintLib"), &Z_Registration_Info_UClass_UHoudiniPublicAPIBlueprintLib, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPIBlueprintLib), 489730813U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h__Script_HoudiniEngineEditor_2629091731(TEXT("/Script/HoudiniEngineEditor"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h__Script_HoudiniEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIBlueprintLib_h__Script_HoudiniEngineEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
