...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniEditorAssetStateSubsystem;
UClass* UHoudiniEditorAssetStateSubsystem::GetPrivateStaticClass()
{
	using TClass = UHoudiniEditorAssetStateSubsystem;
	if (!Z_Registration_Info_UClass_UHoudiniEditorAssetStateSubsystem.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniEditorAssetStateSubsystem"),
			Z_Registration_Info_UClass_UHoudiniEditorAssetStateSubsystem.InnerSingleton,
			StaticRegisterNativesUHoudiniEditorAssetStateSubsystem,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniEditorAssetStateSubsystem.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniEditorAssetStateSubsystem_NoRegister()
{
	return UHoudiniEditorAssetStateSubsystem::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEditorAssetStateSubsystem_h__Script_HoudiniEngineEditor_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniEditorAssetStateSubsystem, UHoudiniEditorAssetStateSubsystem::StaticClass, TEXT("UHoudiniEditorAssetStateSubsystem"), &Z_Registration_Info_UClass_UHoudiniEditorAssetStateSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniEditorAssetStateSubsystem), 2073904667U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEditorAssetStateSubsystem_h__Script_HoudiniEngineEditor_3485497115(TEXT("/Script/HoudiniEngineEditor"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEditorAssetStateSubsystem_h__Script_HoudiniEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniEditorAssetStateSubsystem_h__Script_HoudiniEngineEditor_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
