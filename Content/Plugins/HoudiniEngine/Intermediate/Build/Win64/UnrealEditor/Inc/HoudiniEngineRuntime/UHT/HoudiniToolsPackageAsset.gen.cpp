...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniToolsPackageAsset;
UClass* UHoudiniToolsPackageAsset::GetPrivateStaticClass()
{
	using TClass = UHoudiniToolsPackageAsset;
	if (!Z_Registration_Info_UClass_UHoudiniToolsPackageAsset.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniToolsPackageAsset"),
			Z_Registration_Info_UClass_UHoudiniToolsPackageAsset.InnerSingleton,
			StaticRegisterNativesUHoudiniToolsPackageAsset,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniToolsPackageAsset.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniToolsPackageAsset_NoRegister()
{
	return UHoudiniToolsPackageAsset::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniToolsPackageAsset_Statics::NewProp_Categories_ValueProp = { "Categories", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FCategoryRules, METADATA_PARAMS(0, nullptr) }; // 3220661431
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolsPackageAsset_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniToolsPackageAsset, UHoudiniToolsPackageAsset::StaticClass, TEXT("UHoudiniToolsPackageAsset"), &Z_Registration_Info_UClass_UHoudiniToolsPackageAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniToolsPackageAsset), 1513490119U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolsPackageAsset_h__Script_HoudiniEngineRuntime_2338386501(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolsPackageAsset_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniToolsPackageAsset_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
