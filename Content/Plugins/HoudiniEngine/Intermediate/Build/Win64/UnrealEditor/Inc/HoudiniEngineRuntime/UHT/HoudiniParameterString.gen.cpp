...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterString;
UClass* UHoudiniParameterString::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterString;
	if (!Z_Registration_Info_UClass_UHoudiniParameterString.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterString"),
			Z_Registration_Info_UClass_UHoudiniParameterString.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterString,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterString.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterString_NoRegister()
{
	return UHoudiniParameterString::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterString_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterString, UHoudiniParameterString::StaticClass, TEXT("UHoudiniParameterString"), &Z_Registration_Info_UClass_UHoudiniParameterString, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterString), 2925687495U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterString_h__Script_HoudiniEngineRuntime_3550187029(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterString_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterString_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
