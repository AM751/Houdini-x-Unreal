...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterColor;
UClass* UHoudiniParameterColor::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterColor;
	if (!Z_Registration_Info_UClass_UHoudiniParameterColor.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterColor"),
			Z_Registration_Info_UClass_UHoudiniParameterColor.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterColor,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterColor.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterColor_NoRegister()
{
	return UHoudiniParameterColor::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterColor_h__Script_HoudiniEngineRuntime_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterColor, UHoudiniParameterColor::StaticClass, TEXT("UHoudiniParameterColor"), &Z_Registration_Info_UClass_UHoudiniParameterColor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterColor), 1670233497U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterColor_h__Script_HoudiniEngineRuntime_2130058634(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterColor_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterColor_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
