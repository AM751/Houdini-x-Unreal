...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIInput_GetInputObjects);
	...
	{
		return GetInputObjects_Implementation(OutObjects);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIInput_IsAcceptableObjectForInput);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		HoudiniPublicAPIInput_eventIsAcceptableObjectForInput_Parms Parms;
		Parms.InObject=InObject;
		const_cast<UHoudiniPublicAPIInput*>(this)->ProcessEvent(Func,&Parms);
		return !!Parms.ReturnValue;
	}
	else
	{
		return const_cast<UHoudiniPublicAPIInput*>(this)->IsAcceptableObjectForInput_Implementation(InObject);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIInput_SetInputObjects);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return SetInputObjects_Implementation(InObjects);
	}
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPublicAPIInput;
UClass* UHoudiniPublicAPIInput::GetPrivateStaticClass()
{
	using TClass = UHoudiniPublicAPIInput;
	if (!Z_Registration_Info_UClass_UHoudiniPublicAPIInput.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPublicAPIInput"),
			Z_Registration_Info_UClass_UHoudiniPublicAPIInput.InnerSingleton,
			StaticRegisterNativesUHoudiniPublicAPIInput,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniPublicAPIInput.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPublicAPIInput_NoRegister()
{
	return UHoudiniPublicAPIInput::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniPublicAPIInput_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniPublicAPIInput_GetInputObjects, "GetInputObjects" }, // 1583023669
		{ &Z_Construct_UFunction_UHoudiniPublicAPIInput_IsAcceptableObjectForInput, "IsAcceptableObjectForInput" }, // 3834628490
		{ &Z_Construct_UFunction_UHoudiniPublicAPIInput_SetInputObjects, "SetInputObjects" }, // 645530687
	};
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffset);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		...
		const_cast<UHoudiniPublicAPIGeoInput*>(this)->ProcessEvent(Func,&Parms);
		OutTransform=Parms.OutTransform;
		return !!Parms.ReturnValue;
	}
	else
	{
		return const_cast<UHoudiniPublicAPIGeoInput*>(this)->GetInputObjectTransformOffset_Implementation(InInputObjectIndex, OutTransform);
	}
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffset_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UHoudiniPublicAPIGeoInput, nullptr, "GetInputObjectTransformOffset", Z_Construct_UFunction_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffset_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffset_Statics::PropPointers), sizeof(HoudiniPublicAPIGeoInput_eventGetInputObjectTransformOffset_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x5CC20C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffset_Statics::Function_MetaDataParams), Z_Construct_UFunction_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffset_Statics::Function_MetaDataParams)},  };
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffsetArray);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UHoudiniPublicAPIGeoInput*>(this)->GetInputObjectTransformOffsetArray_Implementation(OutInputObjectTransformOffsetArray);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPIGeoInput_SetInputObjectTransformOffset);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return SetInputObjectTransformOffset_Implementation(InInputObjectIndex, InTransform);
	}
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPublicAPIGeoInput;
UClass* UHoudiniPublicAPIGeoInput::GetPrivateStaticClass()
{
	using TClass = UHoudiniPublicAPIGeoInput;
	if (!Z_Registration_Info_UClass_UHoudiniPublicAPIGeoInput.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPublicAPIGeoInput"),
			Z_Registration_Info_UClass_UHoudiniPublicAPIGeoInput.InnerSingleton,
			StaticRegisterNativesUHoudiniPublicAPIGeoInput,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniPublicAPIGeoInput.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPublicAPIGeoInput_NoRegister()
{
	return UHoudiniPublicAPIGeoInput::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniPublicAPIGeoInput_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bExportMainGeometry_MetaData[] = {
		{ "Category", "Houdini Engine | Public API | Inputs" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Indicates that the main mesh/geo should be marshalled to Houdini */" },
#endif
		{ "ModuleRelativePath", "Public/HoudiniPublicAPIInputTypes.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Indicates that the main mesh/geo should be marshalled to Houdini" },
#endif
	};
	...
	static void NewProp_bExportMainGeometry_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bExportMainGeometry;
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffset, "GetInputObjectTransformOffset" }, // 2810964495
		{ &Z_Construct_UFunction_UHoudiniPublicAPIGeoInput_GetInputObjectTransformOffsetArray, "GetInputObjectTransformOffsetArray" }, // 498226455
		{ &Z_Construct_UFunction_UHoudiniPublicAPIGeoInput_SetInputObjectTransformOffset, "SetInputObjectTransformOffset" }, // 1371444820
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
void Z_Construct_UClass_UHoudiniPublicAPIGeoInput_Statics::NewProp_bExportMainGeometry_SetBit(void* Obj)
{
	((UHoudiniPublicAPIGeoInput*)Obj)->bExportMainGeometry = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniPublicAPIGeoInput_Statics::NewProp_bExportMainGeometry = { "bExportMainGeometry", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHoudiniPublicAPIGeoInput), &Z_Construct_UClass_UHoudiniPublicAPIGeoInput_Statics::NewProp_bExportMainGeometry_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bExportMainGeometry_MetaData), NewProp_bExportMainGeometry_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHoudiniPublicAPIGeoInput_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniPublicAPIGeoInput_Statics::NewProp_bExportMainGeometry,
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_AppendCurvePoint);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		AppendCurvePoint_Implementation(InCurvePoint);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_ClearCurvePoints);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		ClearCurvePoints_Implementation();
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_GetCurveBreakpointParameterization);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		HoudiniPublicAPICurveInputObject_eventGetCurveBreakpointParameterization_Parms Parms;
		const_cast<UHoudiniPublicAPICurveInputObject*>(this)->ProcessEvent(Func,&Parms);
		return Parms.ReturnValue;
	}
	else
	{
		return const_cast<UHoudiniPublicAPICurveInputObject*>(this)->GetCurveBreakpointParameterization_Implementation();
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_GetCurveMethod);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UHoudiniPublicAPICurveInputObject*>(this)->GetCurveMethod_Implementation();
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_GetCurvePoints);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		const_cast<UHoudiniPublicAPICurveInputObject*>(this)->GetCurvePoints_Implementation(OutCurvePoints);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_GetCurveType);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UHoudiniPublicAPICurveInputObject*>(this)->GetCurveType_Implementation();
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_IsClosed);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UHoudiniPublicAPICurveInputObject*>(this)->IsClosed_Implementation();
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_IsReversed);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UHoudiniPublicAPICurveInputObject*>(this)->IsReversed_Implementation();
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_SetClosed);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SetClosed_Implementation(bInClosed);
	}
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetClosed_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UHoudiniPublicAPICurveInputObject, nullptr, "SetClosed", Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetClosed_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetClosed_Statics::PropPointers), sizeof(HoudiniPublicAPICurveInputObject_eventSetClosed_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetClosed_Statics::Function_MetaDataParams), Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetClosed_Statics::Function_MetaDataParams)},  };
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_SetCurveBreakpointParameterization);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SetCurveBreakpointParameterization_Implementation(InCurveBreakpointParameterization);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_SetCurveMethod);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SetCurveMethod_Implementation(InCurveMethod);
	}
}
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurveMethod_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UClass_UHoudiniPublicAPICurveInputObject, nullptr, "SetCurveMethod", Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurveMethod_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurveMethod_Statics::PropPointers), sizeof(HoudiniPublicAPICurveInputObject_eventSetCurveMethod_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurveMethod_Statics::Function_MetaDataParams), Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurveMethod_Statics::Function_MetaDataParams)},  };
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_SetCurvePoints);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SetCurvePoints_Implementation(InCurvePoints);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_SetCurveType);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SetCurveType_Implementation(InCurveType);
	}
}
...
{
	UFunction* Func = FindFunctionChecked(NAME_UHoudiniPublicAPICurveInputObject_SetReversed);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SetReversed_Implementation(bInReversed);
	}
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPublicAPICurveInputObject;
UClass* UHoudiniPublicAPICurveInputObject::GetPrivateStaticClass()
{
	using TClass = UHoudiniPublicAPICurveInputObject;
	if (!Z_Registration_Info_UClass_UHoudiniPublicAPICurveInputObject.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPublicAPICurveInputObject"),
			Z_Registration_Info_UClass_UHoudiniPublicAPICurveInputObject.InnerSingleton,
			StaticRegisterNativesUHoudiniPublicAPICurveInputObject,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniPublicAPICurveInputObject.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPublicAPICurveInputObject_NoRegister()
{
	return UHoudiniPublicAPICurveInputObject::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniPublicAPICurveInputObject_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_AppendCurvePoint, "AppendCurvePoint" }, // 3536183368
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_ClearCurvePoints, "ClearCurvePoints" }, // 2677647343
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_GetCurveBreakpointParameterization, "GetCurveBreakpointParameterization" }, // 2914961540
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_GetCurveMethod, "GetCurveMethod" }, // 1197417976
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_GetCurvePoints, "GetCurvePoints" }, // 3797945100
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_GetCurveType, "GetCurveType" }, // 112005212
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_IsClosed, "IsClosed" }, // 3652094111
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_IsReversed, "IsReversed" }, // 1193532993
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetClosed, "SetClosed" }, // 3997442691
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurveBreakpointParameterization, "SetCurveBreakpointParameterization" }, // 3374606743
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurveMethod, "SetCurveMethod" }, // 135084633
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurvePoints, "SetCurvePoints" }, // 3621293364
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetCurveType, "SetCurveType" }, // 3393735991
		{ &Z_Construct_UFunction_UHoudiniPublicAPICurveInputObject_SetReversed, "SetReversed" }, // 1058869982
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPublicAPICurveInput;
UClass* UHoudiniPublicAPICurveInput::GetPrivateStaticClass()
{
	using TClass = UHoudiniPublicAPICurveInput;
	if (!Z_Registration_Info_UClass_UHoudiniPublicAPICurveInput.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPublicAPICurveInput"),
			Z_Registration_Info_UClass_UHoudiniPublicAPICurveInput.InnerSingleton,
			StaticRegisterNativesUHoudiniPublicAPICurveInput,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniPublicAPICurveInput.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPublicAPICurveInput_NoRegister()
{
	return UHoudiniPublicAPICurveInput::GetPrivateStaticClass();
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPublicAPIWorldInput;
UClass* UHoudiniPublicAPIWorldInput::GetPrivateStaticClass()
{
	using TClass = UHoudiniPublicAPIWorldInput;
	if (!Z_Registration_Info_UClass_UHoudiniPublicAPIWorldInput.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPublicAPIWorldInput"),
			Z_Registration_Info_UClass_UHoudiniPublicAPIWorldInput.InnerSingleton,
			StaticRegisterNativesUHoudiniPublicAPIWorldInput,
			sizeof(TClass),
			alignof(TClass),
			TClass::StaticClassFlags,
			TClass::StaticClassCastFlags(),
	...
	return Z_Registration_Info_UClass_UHoudiniPublicAPIWorldInput.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPublicAPIWorldInput_NoRegister()
{
	return UHoudiniPublicAPIWorldInput::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UHoudiniPublicAPIWorldInput_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bWorldInputAutoUpdate_MetaData[] = {
		{ "Category", "Houdini Engine | Public API | Inputs" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** Indicates that selected actors by the bound selectors should update automatically */" },
#endif
	...
	static void NewProp_bWorldInputAutoUpdate_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bWorldInputAutoUpdate;
...
void Z_Construct_UClass_UHoudiniPublicAPIWorldInput_Statics::NewProp_bWorldInputAutoUpdate_SetBit(void* Obj)
{
	((UHoudiniPublicAPIWorldInput*)Obj)->bWorldInputAutoUpdate = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UHoudiniPublicAPIWorldInput_Statics::NewProp_bWorldInputAutoUpdate = { "bWorldInputAutoUpdate", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UHoudiniPublicAPIWorldInput), &Z_Construct_UClass_UHoudiniPublicAPIWorldInput_Statics::NewProp_bWorldInputAutoUpdate_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bWorldInputAutoUpdate_MetaData), NewProp_bWorldInputAutoUpdate_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHoudiniPublicAPIWorldInput_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHoudiniPublicAPIWorldInput_Statics::NewProp_bWorldInputAutoUpdate,
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIInputTypes_h__Script_HoudiniEngineEditor_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPublicAPIInput, UHoudiniPublicAPIInput::StaticClass, TEXT("UHoudiniPublicAPIInput"), &Z_Registration_Info_UClass_UHoudiniPublicAPIInput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPIInput), 2491806818U) },
		{ Z_Construct_UClass_UHoudiniPublicAPIGeoInput, UHoudiniPublicAPIGeoInput::StaticClass, TEXT("UHoudiniPublicAPIGeoInput"), &Z_Registration_Info_UClass_UHoudiniPublicAPIGeoInput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPIGeoInput), 3227863109U) },
		...
		{ Z_Construct_UClass_UHoudiniPublicAPICurveInput, UHoudiniPublicAPICurveInput::StaticClass, TEXT("UHoudiniPublicAPICurveInput"), &Z_Registration_Info_UClass_UHoudiniPublicAPICurveInput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPICurveInput), 906509493U) },
		{ Z_Construct_UClass_UHoudiniPublicAPIWorldInput, UHoudiniPublicAPIWorldInput::StaticClass, TEXT("UHoudiniPublicAPIWorldInput"), &Z_Registration_Info_UClass_UHoudiniPublicAPIWorldInput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPublicAPIWorldInput), 1677922525U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIInputTypes_h__Script_HoudiniEngineEditor_544272602(TEXT("/Script/HoudiniEngineEditor"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIInputTypes_h__Script_HoudiniEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIInputTypes_h__Script_HoudiniEngineEditor_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIInputTypes_h__Script_HoudiniEngineEditor_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Public_HoudiniPublicAPIInputTypes_h__Script_HoudiniEngineEditor_Statics::EnumInfo));
// ********** End Registration *********************************************************************
