...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniParameterFolder;
UClass* UHoudiniParameterFolder::GetPrivateStaticClass()
{
	using TClass = UHoudiniParameterFolder;
	if (!Z_Registration_Info_UClass_UHoudiniParameterFolder.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniParameterFolder"),
			Z_Registration_Info_UClass_UHoudiniParameterFolder.InnerSingleton,
			StaticRegisterNativesUHoudiniParameterFolder,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniParameterFolder.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniParameterFolder_NoRegister()
{
	return UHoudiniParameterFolder::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolder_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniParameterFolder, UHoudiniParameterFolder::StaticClass, TEXT("UHoudiniParameterFolder"), &Z_Registration_Info_UClass_UHoudiniParameterFolder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniParameterFolder), 2811747536U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolder_h__Script_HoudiniEngineRuntime_3702602339(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolder_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolder_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolder_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniParameterFolder_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
