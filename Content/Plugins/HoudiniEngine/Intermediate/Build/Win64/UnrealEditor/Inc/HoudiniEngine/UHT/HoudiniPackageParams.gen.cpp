...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPackageParams;
class UScriptStruct* FHoudiniPackageParams::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPackageParams.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPackageParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPackageParams, (UObject*)Z_Construct_UPackage__Script_HoudiniEngine(), TEXT("HoudiniPackageParams"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPackageParams.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPackageParams.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPackageParams.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPackageParams.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniPackageParams ***********************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h__Script_HoudiniEngine_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniPackageParams::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPackageParams_Statics::NewStructOps, TEXT("HoudiniPackageParams"), &Z_Registration_Info_UScriptStruct_FHoudiniPackageParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPackageParams), 126944019U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h__Script_HoudiniEngine_1453892607(TEXT("/Script/HoudiniEngine"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h__Script_HoudiniEngine_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h__Script_HoudiniEngine_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h__Script_HoudiniEngine_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngine_Private_HoudiniPackageParams_h__Script_HoudiniEngine_Statics::EnumInfo));
// ********** End Registration *********************************************************************
