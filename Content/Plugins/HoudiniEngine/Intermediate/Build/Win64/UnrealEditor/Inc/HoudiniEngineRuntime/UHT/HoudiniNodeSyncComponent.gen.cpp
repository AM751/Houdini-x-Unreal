...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniNodeSyncComponent;
UClass* UHoudiniNodeSyncComponent::GetPrivateStaticClass()
{
	using TClass = UHoudiniNodeSyncComponent;
	if (!Z_Registration_Info_UClass_UHoudiniNodeSyncComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniNodeSyncComponent"),
			Z_Registration_Info_UClass_UHoudiniNodeSyncComponent.InnerSingleton,
			StaticRegisterNativesUHoudiniNodeSyncComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniNodeSyncComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniNodeSyncComponent_NoRegister()
{
	return UHoudiniNodeSyncComponent::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniNodeSyncComponent_h__Script_HoudiniEngineRuntime_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniNodeSyncComponent, UHoudiniNodeSyncComponent::StaticClass, TEXT("UHoudiniNodeSyncComponent"), &Z_Registration_Info_UClass_UHoudiniNodeSyncComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniNodeSyncComponent), 1463985778U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniNodeSyncComponent_h__Script_HoudiniEngineRuntime_3441765539(TEXT("/Script/HoudiniEngineRuntime"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniNodeSyncComponent_h__Script_HoudiniEngineRuntime_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniNodeSyncComponent_h__Script_HoudiniEngineRuntime_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniNodeSyncComponent_h__Script_HoudiniEngineRuntime_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineRuntime_Private_HoudiniNodeSyncComponent_h__Script_HoudiniEngineRuntime_Statics::EnumInfo));
// ********** End Registration *********************************************************************
