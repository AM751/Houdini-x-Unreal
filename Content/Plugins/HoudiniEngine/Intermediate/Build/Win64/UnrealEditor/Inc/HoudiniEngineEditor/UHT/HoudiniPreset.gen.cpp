...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetBase;
class UScriptStruct* FHoudiniPresetBase::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetBase.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetBase, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetBase"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetBase.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetBase.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetBase.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetBase_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetBase.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetFloatValues;
class UScriptStruct* FHoudiniPresetFloatValues::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetFloatValues.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetFloatValues.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetFloatValues, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetFloatValues"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetFloatValues.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetFloatValues.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetFloatValues.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetFloatValues_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetFloatValues.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetIntValues;
class UScriptStruct* FHoudiniPresetIntValues::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetIntValues.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetIntValues.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetIntValues, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetIntValues"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetIntValues.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetIntValues.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetIntValues.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetIntValues_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetIntValues.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetStringValues;
class UScriptStruct* FHoudiniPresetStringValues::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetStringValues.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetStringValues.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetStringValues, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetStringValues"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetStringValues.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetStringValues.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetStringValues.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetStringValues_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetStringValues.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniPresetStringValues ******************************************

// ********** Begin ScriptStruct FHoudiniPresetRampFloatPoint **************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatPoint;
class UScriptStruct* FHoudiniPresetRampFloatPoint::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatPoint.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatPoint.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetRampFloatPoint, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetRampFloatPoint"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatPoint.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatPoint.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatPoint.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetRampFloatPoint_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatPoint.InnerSingleton;
}
// ********** End ScriptStruct FHoudiniPresetRampFloatPoint ****************************************

// ********** Begin ScriptStruct FHoudiniPresetRampColorPoint **************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorPoint;
class UScriptStruct* FHoudiniPresetRampColorPoint::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorPoint.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorPoint.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetRampColorPoint, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetRampColorPoint"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorPoint.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorPoint.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorPoint.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetRampColorPoint_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorPoint.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatValues;
class UScriptStruct* FHoudiniPresetRampFloatValues::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatValues.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatValues.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetRampFloatValues, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetRampFloatValues"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatValues.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatValues.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatValues.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetRampFloatValues_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatValues.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorValues;
class UScriptStruct* FHoudiniPresetRampColorValues::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorValues.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorValues.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetRampColorValues, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetRampColorValues"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorValues.OuterSingleton;
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHoudiniPresetRampColorValues_Statics::NewProp_Points_Inner = { "Points", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FHoudiniPresetRampColorPoint, METADATA_PARAMS(0, nullptr) }; // 2242401617
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FHoudiniPresetRampColorValues_Statics::NewProp_Points = { "Points", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FHoudiniPresetRampColorValues, Points), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Points_MetaData), NewProp_Points_MetaData) }; // 2242401617
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorValues.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorValues.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetRampColorValues_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorValues.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetMultiParmValues;
class UScriptStruct* FHoudiniPresetMultiParmValues::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetMultiParmValues.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetMultiParmValues.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetMultiParmValues, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetMultiParmValues"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetMultiParmValues.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetMultiParmValues.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetMultiParmValues.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetMultiParmValues_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetMultiParmValues.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetGeometryInputObject;
class UScriptStruct* FHoudiniPresetGeometryInputObject::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetGeometryInputObject.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetGeometryInputObject.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetGeometryInputObject, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetGeometryInputObject"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetGeometryInputObject.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetGeometryInputObject.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetGeometryInputObject.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetGeometryInputObject_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetGeometryInputObject.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetCurveInputObject;
class UScriptStruct* FHoudiniPresetCurveInputObject::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetCurveInputObject.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetCurveInputObject.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetCurveInputObject, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetCurveInputObject"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetCurveInputObject.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetCurveInputObject.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetCurveInputObject.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetCurveInputObject_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetCurveInputObject.InnerSingleton;
}
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FHoudiniPresetInputValue;
class UScriptStruct* FHoudiniPresetInputValue::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetInputValue.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FHoudiniPresetInputValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHoudiniPresetInputValue, (UObject*)Z_Construct_UPackage__Script_HoudiniEngineEditor(), TEXT("HoudiniPresetInputValue"));
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetInputValue.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FHoudiniPresetInputValue.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FHoudiniPresetInputValue.InnerSingleton, Z_Construct_UScriptStruct_FHoudiniPresetInputValue_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FHoudiniPresetInputValue.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UHoudiniPreset;
UClass* UHoudiniPreset::GetPrivateStaticClass()
{
	using TClass = UHoudiniPreset;
	if (!Z_Registration_Info_UClass_UHoudiniPreset.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("HoudiniPreset"),
			Z_Registration_Info_UClass_UHoudiniPreset.InnerSingleton,
			StaticRegisterNativesUHoudiniPreset,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UHoudiniPreset.InnerSingleton;
}
UClass* Z_Construct_UClass_UHoudiniPreset_NoRegister()
{
	return UHoudiniPreset::GetPrivateStaticClass();
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniPreset_Statics::NewProp_FloatParameters_ValueProp = { "FloatParameters", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FHoudiniPresetFloatValues, METADATA_PARAMS(0, nullptr) }; // 3338584233
...
const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UHoudiniPreset_Statics::NewProp_RampColorParameters = { "RampColorParameters", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniPreset, RampColorParameters), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RampColorParameters_MetaData), NewProp_RampColorParameters_MetaData) }; // 285387907
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniPreset_Statics::NewProp_MultiParmParameters_ValueProp = { "MultiParmParameters", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, Z_Construct_UScriptStruct_FHoudiniPresetMultiParmValues, METADATA_PARAMS(0, nullptr) }; // 369288399
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniPreset_Statics::NewProp_StaticMeshBuildSettings = { "StaticMeshBuildSettings", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniPreset, StaticMeshBuildSettings), Z_Construct_UScriptStruct_FMeshBuildSettings, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StaticMeshBuildSettings_MetaData), NewProp_StaticMeshBuildSettings_MetaData) }; // 2569424419
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHoudiniPreset_Statics::NewProp_IconImageData = { "IconImageData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHoudiniPreset, IconImageData), Z_Construct_UScriptStruct_FHImageData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_IconImageData_MetaData), NewProp_IconImageData_MetaData) }; // 443080600
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniPreset_h__Script_HoudiniEngineEditor_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FHoudiniPresetBase::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetBase_Statics::NewStructOps, TEXT("HoudiniPresetBase"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetBase), 1719000683U) },
		{ FHoudiniPresetFloatValues::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetFloatValues_Statics::NewStructOps, TEXT("HoudiniPresetFloatValues"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetFloatValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetFloatValues), 3338584233U) },
		{ FHoudiniPresetIntValues::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetIntValues_Statics::NewStructOps, TEXT("HoudiniPresetIntValues"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetIntValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetIntValues), 1921534994U) },
		{ FHoudiniPresetStringValues::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetStringValues_Statics::NewStructOps, TEXT("HoudiniPresetStringValues"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetStringValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetStringValues), 4126717856U) },
		{ FHoudiniPresetRampFloatPoint::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetRampFloatPoint_Statics::NewStructOps, TEXT("HoudiniPresetRampFloatPoint"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatPoint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetRampFloatPoint), 1535086265U) },
		{ FHoudiniPresetRampColorPoint::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetRampColorPoint_Statics::NewStructOps, TEXT("HoudiniPresetRampColorPoint"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorPoint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetRampColorPoint), 2242401617U) },
		{ FHoudiniPresetRampFloatValues::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetRampFloatValues_Statics::NewStructOps, TEXT("HoudiniPresetRampFloatValues"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetRampFloatValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetRampFloatValues), 1645783751U) },
		{ FHoudiniPresetRampColorValues::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetRampColorValues_Statics::NewStructOps, TEXT("HoudiniPresetRampColorValues"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetRampColorValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetRampColorValues), 285387907U) },
		{ FHoudiniPresetMultiParmValues::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetMultiParmValues_Statics::NewStructOps, TEXT("HoudiniPresetMultiParmValues"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetMultiParmValues, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetMultiParmValues), 369288399U) },
		{ FHoudiniPresetGeometryInputObject::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetGeometryInputObject_Statics::NewStructOps, TEXT("HoudiniPresetGeometryInputObject"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetGeometryInputObject, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetGeometryInputObject), 2554779491U) },
		{ FHoudiniPresetCurveInputObject::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetCurveInputObject_Statics::NewStructOps, TEXT("HoudiniPresetCurveInputObject"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetCurveInputObject, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetCurveInputObject), 4159672544U) },
		{ FHoudiniPresetInputValue::StaticStruct, Z_Construct_UScriptStruct_FHoudiniPresetInputValue_Statics::NewStructOps, TEXT("HoudiniPresetInputValue"), &Z_Registration_Info_UScriptStruct_FHoudiniPresetInputValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHoudiniPresetInputValue), 2121051421U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHoudiniPreset, UHoudiniPreset::StaticClass, TEXT("UHoudiniPreset"), &Z_Registration_Info_UClass_UHoudiniPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHoudiniPreset), 715160659U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniPreset_h__Script_HoudiniEngineEditor_1816847677(TEXT("/Script/HoudiniEngineEditor"),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniPreset_h__Script_HoudiniEngineEditor_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniPreset_h__Script_HoudiniEngineEditor_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniPreset_h__Script_HoudiniEngineEditor_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniPreset_h__Script_HoudiniEngineEditor_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniPreset_h__Script_HoudiniEngineEditor_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_HoudiniEngine_Source_HoudiniEngineEditor_Private_HoudiniPreset_h__Script_HoudiniEngineEditor_Statics::EnumInfo));
// ********** End Registration *********************************************************************
